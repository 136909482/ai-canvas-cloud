    ...
    <>
      ...
      {showSettings && (
        <div className="absolute inset-0 z-50 flex items-center justify-center overflow-hidden bg-black/30 px-4 py-6 backdrop-blur-sm">
          <div ref={settingsDialogRef} role="dialog" aria-modal="true" aria-labelledby="settings-dialog-title" tabIndex={-1} className={`flex h-[min(84vh,44rem)] w-[min(94vw,76rem)] flex-col overflow-hidden rounded-[16px] md:grid md:grid-cols-[13rem_minmax(0,1fr)] ${themeClasses.strongPanel}`}>
            ...
            <main className="min-h-0 flex-1 bg-[var(--panel-bg-strong)]">
              {activeCategory === 'models' ? (
                <section key="local-vault" className="settings-content-enter flex h-full min-h-0 flex-col">
