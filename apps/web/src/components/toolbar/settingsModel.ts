...
} from "@/store/useSettingsDialogStore";
import type {
...
export type DraftModelCard = Omit<ModelEntry, "createdAt" | "updatedAt">;
export interface DraftProviderProfile extends ProviderProfileConfig {
  apiKey: string;
...
export const CANVAS_EXPERIENCE_TEXT = {
  ...
  performanceModeHint:
    "\u9ad8\u8d28\u91cf\u4fdd\u7559\u5b8c\u6574\u753b\u5e03\u4f53\u9a8c\uff1b\u9ad8\u6027\u80fd\u51cf\u5c11\u5c0f\u5730\u56fe\u3001\u8fb9\u52a8\u753b\u548c\u91cd\u9634\u5f71\u7b49\u975e\u6838\u5fc3\u89c6\u89c9\u3002",
  canvasGrid: "\u753b\u5e03\u7f51\u683c",
  canvasGridHint:
    "\u663e\u793a\u753b\u5e03\u80cc\u666f\u7f51\u683c\uff1b\u9ad8\u6027\u80fd\u6a21\u5f0f\u4e0b\u4f1a\u81ea\u52a8\u9690\u85cf\u4ee5\u51cf\u5c11\u6e32\u67d3\u8d1f\u62c5\u3002",
  lowQualityPreview: "\u9ad8\u6e05\u56fe\u7247\u9884\u89c8",
  lowQualityPreviewHint:
    "\u5f00\u542f\u65f6\u753b\u5e03\u56fe\u7247\u59cb\u7ec8\u663e\u793a\u539f\u56fe\uff1b\u5173\u95ed\u65f6\u59cb\u7ec8\u4f7f\u7528\u8f83\u5c0f\u7684\u672c\u5730\u7f29\u7565\u56fe\uff0c\u964d\u4f4e\u5927\u56fe\u6e32\u67d3\u8d1f\u62c5\u3002",
...
export const EDGE_STYLE_OPTIONS: Array<{
  ...
  },
  {
    id: "step",
    label: "\u76f4\u89d2\u6298\u7ebf",
    description: "\u9759\u6001 step \u6298\u7ebf",
  },
  {
    id: "smoothstep",
    label: "\u5706\u89d2\u6298\u7ebf",
    description: "\u9759\u6001 smoothstep \u6298\u7ebf",
  },
];
...
export const SETTINGS_CATEGORIES: Array<{
  ...
  },
  {
    id: "storage",
    label: "存储管理",
    description: "容量与项目存储用量",
    Icon: HardDrive,
  },
  {
    id: "canvas",
    label: "画布管理",
    description: "性能、预览、对齐与自动保存",
    Icon: Layers3,
  },
  {
    id: "appearance",
    label: "外观设置",
    description: "主题、网格与连线样式",
    Icon: Palette,
  },
  {
    id: "tasks",
...
export function toDraftModel(model: ModelEntry): DraftModelCard {
  return {
    id: model.id,
...
export function createEmptyProviderDraft(
...
export function toDraftProviderProfile(
...
export function sanitizeDraftModel(model: DraftModelCard): DraftModelCard {
  ...
  return {
    ...model,
    displayName: displayName || modelId || "New Model",
    modelId,
  };
}

export function sanitizeProviderProfile(
  profile: DraftProviderProfile,
): DraftProviderProfile {
...
export function getStatusTone(status: ModelTestStatus, active: boolean) {
  if (status === "success") {
