...
const GROUP_NODE_UNSELECTED_CLASS =
  "border-[color:var(--group-accent-border-muted)]";

function getGroupColorPreset(color: unknown) {
  return (
    GROUP_COLOR_PRESETS.find((preset) => preset.id === color) ??
...
export const GroupNode = memo(function GroupNode({
  ...
  const groupStyle = {
    ...
    "--group-accent-border-muted": colorPreset.accentBorder
      .replace("0.7", "0.42")
      .replace("0.58", "0.34"),
