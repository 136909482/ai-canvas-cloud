...
const CATEGORY_ORDER: NodeLibraryCategoryId[] = [
  "common",
  "text-tools",
  "image-tools",
  "ai-tools",
...
export function createCanvasNodeCatalog(
  actions: CanvasNodeCatalogActions,
): CanvasNodeCategory[] {
  ...
  return CATEGORY_ORDER.map((categoryId) => ({
    ...
    tools: nodeLibraryRegistrations
      ...
      .map((registration) => ({
        ...
        createNode: createByType[
          registration.type as ManualCanvasNodeType
        ] as CreateCanvasNode,
      })),
  }));
}
