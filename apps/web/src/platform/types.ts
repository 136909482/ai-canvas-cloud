...
export type WorkspaceAuditScope =
  "all" | "workspace" | "project" | "settings" | "template";
...
export interface PlatformBridge {
  ...
  writeWorkspaceAsset: (
    input: WriteWorkspaceAssetInput,
  ) => Promise<WorkspaceAssetWriteResult>;
  writeWorkspaceAssetAtPath: (
  ...
  inspectWorkspaceAssets: (
    data: WorkspaceData,
  ) => Promise<WorkspaceAssetDiskInspection>;
  cleanupUnusedWorkspaceAssets: (
    data: WorkspaceData,
  ) => Promise<CleanupWorkspaceAssetsResult>;
  queryWorkspaceAudit: (
    query: WorkspaceAuditQuery,
  ) => Promise<WorkspaceAuditQueryResult>;
  searchWorkspace: (
  ...
  commitProjectBundleImport: (
    input: CommitProjectBundleImportInput,
