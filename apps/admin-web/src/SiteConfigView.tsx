  ...
  return (
    <div className="asset-selector">
      ...
      <div className="asset-selector__body">
        ...
        <span>
          {selected
            ? `${selected.width} × ${selected.height} · ${selected.mimeType}`
            : "使用内置品牌资产"}
        </span>
  ...
  return (
    <section className="workspace-view site-config-view">
      ...
      <div className="site-section">
        <div className="site-section__title">
          <ImageIcon />
          <div>
            <h2>品牌资产</h2>
            <p>只接受经服务端复核的 PNG、JPEG、WebP 或 ICO。</p>
          </div>
        </div>
      ...
      <div className="site-section">
        <div className="site-section__title">
          ...
          <div>
            <h2>主题与功能</h2>
            <p>功能开关进入公开投影，不携带管理字段。</p>
          </div>
        </div>
        <div className="site-controls-row">
          <div>
            <span className="control-label">主题预设</span>
            <div className="segmented compact">
              {(["system", "light", "dark"] as const).map((theme) => (
                <button
                  type="button"
                  className={config.themePreset === theme ? "active" : ""}
                  key={theme}
                  onClick={() =>
                    setConfig((current) => ({ ...current, themePreset: theme }))
                  }
                >
                  {theme === "system"
                    ? "跟随系统"
            ...
            <span className="control-label nav-label">公开导航</span>
            <div className="navigation-enums">
              {(
                [
                  ["home", "产品"],
                  ["help", "支持"],
