...
export interface AuthService {
  register: (input: RegisterRequest, context: AuthRequestContext) => Promise<IssuedAuthSession>
  ...
  resetPassword: (input: PasswordResetRequest, context: AuthRequestContext) => Promise<PasswordResetResponse>
...
export function normalizeRegistrationInput(input: { email: string; password: string }): NormalizedRegistrationInput {
